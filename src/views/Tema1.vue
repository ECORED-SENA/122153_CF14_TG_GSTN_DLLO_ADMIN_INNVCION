...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-4 Analice atentamente cada uno de ellos:
      ...
      .col-lg-9
        .cajon.color-acento-botones.p-4.fnd-2
          ...
          ul.lista-ul--color.fa-lista.mb-0
            li 
              i.fas.fa-check
              span.mb-0 ¿Qué son la población y la muestra? (Con ejemplos).
            li.mb-0
              i.fas.fa-check
              span.mb-0 Tamaño de muestra paso a paso.
